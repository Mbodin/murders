...
Liftium.d('setTagStat a for tag #' + Liftium.chain[slotname][lastOne].tag_id, 1);
...
Liftium.d('setTagStat a for tag #' + Liftium.chain[slotname][i].tag_id, 1);
...
Liftium.getTagStat = function (tag_id, type){
	...
	if (Liftium.e(Liftium.tagStats)){
		Liftium.tagStats = Liftium.getRequestVal("liftium_tag_stats", null) || Liftium.cookie("LTS2") || "";
	}
