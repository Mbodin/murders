...
% #4 :  Argument (sous forme de numéro de joueur) lu actuellement.
	\ifthenelse{\equal{\theplayer}{#4}}{%
		\players@yes{\@ouverture{\getPlayerColor{#4}}#1}{#2\@fermeture{\getPlayerColor{#4}}}%
	}{%
		#3{\@ouverture{\getPlayerColor{#4}}#1}{#2\@fermeture{\getPlayerColor{#4}}}%
	}%
}
